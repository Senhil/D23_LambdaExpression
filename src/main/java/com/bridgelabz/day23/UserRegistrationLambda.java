...
public class UserRegistrationLambda {
    public static void main(String[] args) throws InvalidUserException {
        ...
        firstName.check("^[A-Z]{1}[a-z]{3,}$","Senthil","Happy");
        firstName.check("^[A-Z]{1}[a-z]{3,}$","psk","Happy");
        lastName.check("^[A-Z]{1}[a-z]{3,}$","Kumar","Happy");
        lastName.check("^[A-Z]{1}[a-z]{3,}$","sk","Happy");
        email.check("^[a-zA-Z0-9\\-\\+\\.]+.([a-zA-Z0-9])*@([a-z0-9]+.[a-z]{2,}.([a-z]{2,})?)$","senthil123@gmail.com","Happy");
        email.check("^[a-zA-Z0-9\\-\\+\\.]+.([a-zA-Z0-9])*@([a-z0-9]+.[a-z]{2,}.([a-z]{2,})?)$","sk1#gmail.com","Happy");
